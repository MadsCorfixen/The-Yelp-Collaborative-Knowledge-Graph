...
from Code.KnowledgeGraphEnrichment.create_schema_wiki_mapping import create_schema_wiki_mapping
...
if include_wikidata:
    create_schema_wiki_mapping(read_dir=read_dir, write_dir=write_dir)
